      ...
      <section className='bg-white dark:bg-gray-900'>
        <div className='container px-6 py-12 mx-auto'>
          <div>
            ...
            <p className='mt-3 text-gray-500 dark:text-gray-400'>Seputar pertanyaan atau informasi lainnya?</p>
          </div>
          ...
          <div className='grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2'>
            <div className='grid grid-cols-1 gap-12 md:grid-cols-2'>
              <div>
                ...
                <h2 className='mt-4 text-base font-medium text-gray-800 dark:text-white'>KANTOR PUSAT</h2>
                <p className='mt-2 text-sm text-gray-500 dark:text-gray-400'>D/A WISMA PERHUTANI</p>
                <p className='mt-2 text-sm text-blue-500 dark:text-blue-400'>
                  JALAN VILLA NO.1 GATOT SOBROTO KAV. 17 – 18 JAKARTA SELATAN TLP. 62.21.5252983, FAX. 62.21.5252983
              ...
              <div>
                ...
                <p className='mt-2 text-sm text-gray-500 dark:text-gray-400'>D/A WISMA PERHUTANI</p>
                <p className='mt-2 text-sm text-blue-500 dark:text-blue-400'>
                  JL.SOEKARNO HATTA NO. 628 KM.14 BANDUNG 40292 TLP. 62.22. 7802792
                </p>
              </div>
            </div>
