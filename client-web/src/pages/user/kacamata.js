...
function Kacamata() {
  ...
  const onFormSubmit = async (e) => {
    try {
      ...
      await axios({
        method: 'POST',
        url: `${process.env.API_URL}/claim/kacamata/${localStorage.username}`,
        data: newFormData,
        headers: {
        ...
        <div className='grid gap-10 lg:grid-cols-3 '>
          ...
          <div className='col-span-2 w-full px-8 py-4 mt-10 bg-white rounded-lg shadow-md dark:bg-gray-800 lg:my-12 '>
            ...
            <form onSubmit={onFormSubmit}>
              <div>
                <label className='block text-sm text-gray-500 dark:text-gray-300'>Fotocopi KTP</label>
                <input
                  type='file'
              ...
              <div className='mt-6'>
                <label className='block text-sm text-gray-500 dark:text-gray-300'>Fotocopy Kartu Peserta</label>
                <input
                  type='file'
                  className='block w-full px-3 py-2 mt-2 text-sm text-gray-600 bg-white border border-gray-200 rounded-lg file:bg-gray-200 file:text-gray-700 file:text-sm file:px-4 file:py-1 file:border-none file:rounded-full dark:file:bg-gray-800 dark:file:text-gray-200 dark:text-gray-300 placeholder-gray-400/70 dark:placeholder-gray-500 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:focus:border-blue-300'
                  name='fotokopi_kp'
              ...
              <div className='mt-6'>
                <label className='block text-sm text-gray-500 dark:text-gray-300'>Fotocopy SK Pensiun</label>
                <input
                  type='file'
                  className='block w-full px-3 py-2 mt-2 text-sm text-gray-600 bg-white border border-gray-200 rounded-lg file:bg-gray-200 file:text-gray-700 file:text-sm file:px-4 file:py-1 file:border-none file:rounded-full dark:file:bg-gray-800 dark:file:text-gray-200 dark:text-gray-300 placeholder-gray-400/70 dark:placeholder-gray-500 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:focus:border-blue-300'
              ...
              <div className='mt-6'>
                <label className='block text-sm text-green-600'>All in One</label>
                <input
                  type='file'
